...
const DetailsBanner = ({video, crew}) => {
    ...
    const {data, loading} = useFetch(`/${type}/${id}?api_key=${React_API}`)
...
<ContentWrapper>
    ...
    {data.poster_path ? (
            ...
            <Img
                className="posterImg"
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS8k65o_kBTcvVxn4hc6g1WYOQZsJdnftcz_ByOzmLu&s"
            />
        )}
    </div>
    <div className='right'>
